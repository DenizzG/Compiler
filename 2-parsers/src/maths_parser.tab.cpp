...
static const yytype_int8 yypact[] =
{
      ...
      27,    28,    -7,    -6,    -7,    12,    -7,    -5,    -5,    -5,
      -5,    -5,    -5,    -7,    27,    27,    28,    28,    28,    17,
      -7
};
...
{
       0,     0,     0,    16,    17,    18,    12,    15,     0,     2,
       5,     6,     9,     0,    10,     0,     1,     0,     0,     0,
       0,     0,     0,    14,     3,     4,     7,     8,    11,     0,
      13
};
...
#line 1144 "src/maths_parser.tab.cpp"
  ...
  case 13: /* FACTOR: FUNCTION_NAME T_LBRACKET EXPR T_RBRACKET  */
#line 66 "src/maths_parser.y"
                                                 {
                       if (*(yyvsp[-3].string) == "log") (yyval.expr) = new LogFunction((yyvsp[-1].expr));
                       else if (*(yyvsp[-3].string) == "exp")  (yyval.expr) = new ExpFunction((yyvsp[-1].expr));
                       else if (*(yyvsp[-3].string) == "sqrt")  (yyval.expr) = new SqrtFunction((yyvsp[-1].expr));
                       }
